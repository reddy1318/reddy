...
#4te a Python function to create and print a list where the values are the squares of numbers between 1 and 10 (both included)
def create_square_list():
    square_list=[x**1 for x in range(1,11)]
    return square_list
squares=create_square_list()
print(squares)
#5Write a Python function to sum all the numbers in a list.
